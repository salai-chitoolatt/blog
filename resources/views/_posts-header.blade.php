<header class="max-w-4xl mx-auto mt-20 text-center">
    <div class="max-w-xl mx-auto">
      ...
      <h2 class="inline-flex mt-2">
        By Lary Laracore
        <img src="./images/lary-head.svg" alt="Head of Larry the mascots" />
      </h2>
    ...
    <div class="tw-flex tw-justify-center space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
      ...
      <span class="
        ...
        <svg class="transform -rotate-90 absolute pointer-events-none" style="right: 0px" width="22" height="22"
          viewBox="0 0 22 22">
      ...
      <span class="
        ...
        <select class="
              ...
              font-semibold
            ">
          <option value="others" disabled selected>Other Filters</option>
